...
export const en: Translations = {
  ...
  sections: {
    ...
    schedule: {
      title: "Schedule",
      note: "Will be added, but tentatively it looks like this:",
      content: {
        ...
        quiz: "Wedding quiz",
        barbecue: "Barbecue",
        band: "Arrival of live band\nand the first dance",
        lateRefreshments: "Late refreshments",
        end: "End of the official program,\nbut the party will continue until the morning",
      },
    },
    confirmation: {
